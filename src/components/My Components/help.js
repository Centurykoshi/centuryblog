            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 ">
                ...
                <div className="">
                    ...
                    <div className="flex flex-col ml-[30vh] sm:ml-[10vh] gap-6 lg:ml-[30vh] ">
                        {initialDetails.filter((blog) => iscategory === "All" || blog.Tag === iscategory).map((blog) => <BlogCard blog={blog} key={blog.id} onTitleClick={setIscategory} />)}
                        ...
                        <div className="flex justify-center">
                            <div className="flex-col flex gap-10">
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    {initialDetails.slice(0, 5).map((blog) => (
                                        <Link
                                            key={blog.id}
                                            href={`/blog/${blog.slug}`}
